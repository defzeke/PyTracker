from flask import Flask, render_template, request, redirect, url_for, session, make_response, jsonify, Blueprint
...
class User(ABC):
    ...
    @abstractmethod
    @user_bp.route("/attendance_heatmap_data")
